...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	serverLinesService := service.NewServerLinesService(settingRepository)
	adminServerLinesHandler := admin.NewServerLinesHandler(serverLinesService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, paymentHandler, adminServerLinesHandler)
	...
	publicHandler := handler.NewPublicHandler(paymentConfigService, opsService, serverLinesService)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, publicHandler, idempotencyCoordinator, idempotencyCleanupService)
